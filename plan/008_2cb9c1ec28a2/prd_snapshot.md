...
*Continue with `SPEC_FIRMWARE.md`.* | Cargo build profile, per-platform installers (Inno/PKGBUILD/DMG), **community package-manager channels (AUR / .deb / .rpm / Homebrew cask / Scoop / Winget / Nix flake)**, CI release workflow, code signing, the dev test loop. |
