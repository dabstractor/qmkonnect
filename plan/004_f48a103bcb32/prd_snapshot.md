...
*Continue with `SPEC_PLATFORMS.md`.* | The Raw HID wire protocol: payload format, report framing, constants, the `qmk-notifier` crate contract, device matching & discovery, retry/cache. |
